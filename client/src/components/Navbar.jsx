    ...
    <div className='shadow py-4'>
        <div className='container px-4 2x1:px-20 mx-auto flex justify-between items-center'>
            <img src={assets.logo} alt='' />
            {
                ...
                {/* <button onClick={ e => openSignIn()} className='bg-blue-600 text-white px-6 sm:px-9 py-2 rounded-full'>Login</button> So this code is previous working below code i get the code  */}
